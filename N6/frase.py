...
NODE_NAME = os.environ.get("NODE_NAME", "N6")
NODE_PORT = int(os.environ.get("NODE_PORT", 5006))
FRASE = "allí donde tu suave ala se posa."
ID = 8
PEERS = ["N2"]
PORTS = {"N2": 5002}
...
def get_all_frases():
    ...
    for peer in PEERS:
        ...
        try:
            ...
            pass
    # Si este nodo es el origen (no se recibió 'from'), formatea la respuesta
    if not from_node:
